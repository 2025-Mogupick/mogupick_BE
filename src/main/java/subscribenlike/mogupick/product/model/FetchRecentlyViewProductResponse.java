...
public record FetchRecentlyViewProductResponse(
    ...
    public static FetchRecentlyViewProductResponse of(FetchProductResponse product, FetchBrandResponse brand, FetchReviewResponse review, ProductOption option, long viewCount, LocalDateTime lastViewedAt) {
