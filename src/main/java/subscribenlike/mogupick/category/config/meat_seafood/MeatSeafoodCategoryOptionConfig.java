...
import subscribenlike.mogupick.category.config.meat_seafood.MeatCategoryOptionConfig;
import subscribenlike.mogupick.category.config.meat_seafood.EggCategoryOptionConfig;
import subscribenlike.mogupick.category.config.meat_seafood.SeafoodCategoryOptionConfig;
...
public class MeatSeafoodCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public MeatSeafoodCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.MEAT, new MeatCategoryOptionConfig(),
                SubCategory.EGG, new EggCategoryOptionConfig(),
                SubCategory.SEAFOOD, new SeafoodCategoryOptionConfig()
        );
