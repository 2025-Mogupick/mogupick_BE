...
import subscribenlike.mogupick.category.config.daily_goods.KitchenCategoryOptionConfig;
import subscribenlike.mogupick.category.config.daily_goods.CleaningCategoryOptionConfig;
...
public class DailyGoodsCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public DailyGoodsCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.KITCHEN, new KitchenCategoryOptionConfig(),
                SubCategory.CLEANING, new CleaningCategoryOptionConfig()
        );
