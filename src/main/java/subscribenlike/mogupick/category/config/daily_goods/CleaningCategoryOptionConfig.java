...
public class CleaningCategoryOptionConfig implements CategoryOptionConfig {

    private List<CategoryOption> options;
    private Map<CategoryOption, List<CategoryOptionFilter>> filters;

    public CleaningCategoryOptionConfig() {
        init();
    }
    ...
    private void init() {
        ...
        this.filters = Map.of(
                ...
                CategoryOption.WASHER_TYPE, Arrays.asList(
                        CategoryOptionFilter.of("일반", "GENERAL"),
                        CategoryOptionFilter.of("드럼", "DRUM"),
                        CategoryOptionFilter.of("공용", "UNIVERSAL")
                ),
