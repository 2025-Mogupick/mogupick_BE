...
public class FreshFoodCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public FreshFoodCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.FRUIT, new FruitCategoryOptionConfig(),
                SubCategory.VEGETABLE, new VegetableCategoryOptionConfig(),
                SubCategory.RICE_GRAINS, new RiceGrainsCategoryOptionConfig()
        );
