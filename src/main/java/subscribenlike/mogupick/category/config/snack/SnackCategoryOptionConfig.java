...
import subscribenlike.mogupick.category.config.snack.ChocolateCandyGumCategoryOptionConfig;
...
public class SnackCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public SnackCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.SNACKS, new SnacksCategoryOptionConfig(),
                SubCategory.CHOCOLATE_CANDY, new ChocolateCandyGumCategoryOptionConfig()
        );
