...
public class SnacksCategoryOptionConfig implements CategoryOptionConfig {

    private List<CategoryOption> options;
    private Map<CategoryOption, List<CategoryOptionFilter>> filters;

    public SnacksCategoryOptionConfig() {
        init();
    }
    ...
    private void init() {
        ...
        this.filters = Map.of(
                ...
                CategoryOption.PACKAGING_TYPE, Arrays.asList(
                        ...
                        CategoryOptionFilter.of("컵(1회분)", "CUP_PORTION")
                ),
                CategoryOption.SNACK_TYPE, Arrays.asList(
                        CategoryOptionFilter.of("봉지과자", "BAG_SNACK"),
                        CategoryOptionFilter.of("과자", "SNACK"),
                        CategoryOptionFilter.of("쿠키", "COOKIE"),
                        CategoryOptionFilter.of("비스켓", "BISCUIT"),
                        CategoryOptionFilter.of("시리얼", "CEREAL"),
                        CategoryOptionFilter.of("바", "BAR"),
                        CategoryOptionFilter.of("파이", "PIE"),
                        CategoryOptionFilter.of("케이크", "CAKE"),
                        CategoryOptionFilter.of("카스타드", "CUSTARD")
                ),
                CategoryOption.FLAVOR, Arrays.asList(
                        CategoryOptionFilter.of("달콤", "SWEET"),
                        CategoryOptionFilter.of("짭짤", "SALTY"),
                        CategoryOptionFilter.of("고소", "NUTTY"),
                        CategoryOptionFilter.of("매콤", "SPICY"),
                        CategoryOptionFilter.of("새콤", "SOUR"),
