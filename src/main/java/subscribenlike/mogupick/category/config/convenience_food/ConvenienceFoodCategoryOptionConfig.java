...
import subscribenlike.mogupick.category.config.convenience_food.FrozenCategoryOptionConfig;
import subscribenlike.mogupick.category.config.convenience_food.MealKitCategoryOptionConfig;
import subscribenlike.mogupick.category.config.convenience_food.LunchSaladCategoryOptionConfig;
...
public class ConvenienceFoodCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public ConvenienceFoodCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.FROZEN, new FrozenCategoryOptionConfig(),
                SubCategory.MEAL_KIT, new MealKitCategoryOptionConfig(),
                SubCategory.LUNCH_SALAD, new LunchSaladCategoryOptionConfig()
        );
