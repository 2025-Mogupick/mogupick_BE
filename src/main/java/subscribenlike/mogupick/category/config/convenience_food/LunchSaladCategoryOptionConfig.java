...
public class LunchSaladCategoryOptionConfig implements CategoryOptionConfig {

    private List<CategoryOption> options;
    private Map<CategoryOption, List<CategoryOptionFilter>> filters;

    public LunchSaladCategoryOptionConfig() {
        init();
    }

    private void init() {
        // 도시락 샐러드 서브카테고리 옵션 초기화
