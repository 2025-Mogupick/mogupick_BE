...
public class PetToyHouseCategoryOptionConfig implements CategoryOptionConfig {

    private List<CategoryOption> options;
    private Map<CategoryOption, List<CategoryOptionFilter>> filters;

    public PetToyHouseCategoryOptionConfig() {
        init();
    }

    private void init() {
        // 고양이 용품 서브카테고리 옵션 초기화
        this.options = Arrays.asList(
                ...
                CategoryOption.SAND_TYPE,
                CategoryOption.SAND_KIND,
                CategoryOption.TOTAL_QUANTITY
        );

        // 고양이 용품 서브카테고리 필터 초기화
        this.filters = Map.of(
                ...
                CategoryOption.SAND_TYPE, Arrays.asList(
                        CategoryOptionFilter.of("응고형", "COAGULATION_TYPE"),
                        CategoryOptionFilter.of("흡수형", "ABSORPTION_TYPE")
                ),
                CategoryOption.SAND_KIND, Arrays.asList(
                        CategoryOptionFilter.of("벤토나이트", "BENTONITE"),
                        CategoryOptionFilter.of("두부모래", "TOFU_SAND"),
                        CategoryOptionFilter.of("나무(종이)", "WOOD_PAPER"),
                        CategoryOptionFilter.of("옥수수", "CORN"),
                        CategoryOptionFilter.of("크리스탈모래", "CRYSTAL_SAND")
                ),
