...
public class CatFoodCategoryOptionConfig implements CategoryOptionConfig {

    private List<CategoryOption> options;
    private Map<CategoryOption, List<CategoryOptionFilter>> filters;

    public CatFoodCategoryOptionConfig() {
        init();
    }

    private void init() {
        // 고양이 사료 및 간식 서브카테고리 옵션 초기화
        this.options = Arrays.asList(
                ...
                CategoryOption.HAIRBALL_CONTROL
        );

        // 고양이 사료 및 간식 서브카테고리 필터 초기화
        this.filters = Map.of(
                ...
                CategoryOption.HAIRBALL_CONTROL, Arrays.asList(
                        CategoryOptionFilter.of("헤어볼억제", "HAIRBALL_CONTROL"),
                        CategoryOptionFilter.of("헤어볼억제/제거기능", "HAIRBALL_CONTROL_REMOVAL")
                )
        );
    }
