...
import subscribenlike.mogupick.category.config.dairy_beverage.WaterCategoryOptionConfig;
import subscribenlike.mogupick.category.config.dairy_beverage.DairyProductsCategoryOptionConfig;
import subscribenlike.mogupick.category.config.dairy_beverage.BeverageCategoryOptionConfig;
...
public class DairyBeverageCategoryOptionConfig implements CategoryOptionConfig {
    ...
    public DairyBeverageCategoryOptionConfig() {
        init();
    }

    private void init() {
        this.subCategoryConfigs = Map.of(
                SubCategory.WATER, new WaterCategoryOptionConfig(),
                SubCategory.DAIRY_PRODUCTS, new DairyProductsCategoryOptionConfig(),
                SubCategory.BEVERAGE, new BeverageCategoryOptionConfig()
        );
